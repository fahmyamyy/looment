...
public class FollowController extends BaseController {
    ...
    public PaginationResponse getFollowers(
        ...
        Pair<List<FollowResponse>, Pagination> pagination = followService.getFollowers(pageable, id);
    ...
    public PaginationResponse getFollowings(
        ...
        Pair<List<FollowResponse>, Pagination> pagination = followService.getFollowings(pageable, id);
