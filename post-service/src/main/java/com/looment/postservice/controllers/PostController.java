...
public class PostController extends BaseController {
    ...
    @PatchMapping("{postId}")
    public ResponseEntity<BaseResponse> updatePost(@PathVariable UUID postId, @RequestBody UpdatePostRequest updatePostRequest) {
    ...
    public ResponseEntity<BaseResponse> infoPost(@PathVariable UUID postId) {
        ...
        return responseCreated("Successfully fetch Post info", postInfoResponse);
    }
    ...
    public ResponseEntity<BaseResponse> toggleCommentable(@PathVariable UUID postId) {
        ...
        return responseCreated("Successfully toggling Post commentable");
    }

    @DeleteMapping("{postId}")
    public ResponseEntity<BaseResponse> deletePost(@PathVariable UUID postId) {
        postService.deletePost(postId);
        return responseDelete("Successfully delete Post");
    }
}